...
![Status](https://img.shields.io/badge/Milestone_2-Not_Started-lightgrey)
...
| [`04-packet-tracer/`](./04-packet-tracer) | Packet Tracer `.pkt` file(s) |
...
- [ ] Working Packet Tracer file
- [ ] Assigned feature implemented (WPA2-PSK wireless security)
- [ ] Testing evidence
